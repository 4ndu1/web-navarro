...
async function bootstrap() {
    ...
    const teacherRepo = dataSource.getRepository(teacher_entity_1.Teacher);
    ...
    for (const item of DATA) {
        ...
        if (!section) {
            section = sectionRepo.create({
                nombre: sectionName,
                year: '2024-2025',
                code: `GE-${Math.floor(Math.random() * 10000)}`,
                teacher: teacher,
            });
...
bootstrap();
//# sourceMappingURL=seed_groups.js.map